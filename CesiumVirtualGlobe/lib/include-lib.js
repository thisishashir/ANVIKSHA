...
; (function () {
  ...
  // Current version number for clearing browser cache
  var cacheVersion = '20190418'

  // cssExpr is used to check if resource is CSS
  ...
  function load() {
    ...
    var libsConfig = {
      ...
      admui: [
        ...
        libpath + 'admui/js/global/core.js', // Core
      ...
      'cesium-mars': [
        ...
        libpath + 'CesiumPlugins/navigation/viewerCesiumNavigationMixin.css', // Navigation
