...
function createHeatmapImageryProvider(Cesium, options) {
    ...
    var HeatmapImageryProvider = function (options) {
        ...
        // Calculate data max/min values and boundaries - start
        ...
        // Calculate data max/min values and boundaries - end
        ...
        this._heatmap = chInstance.create(this._options); // Heatmap object
