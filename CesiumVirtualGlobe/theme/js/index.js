...
function initView() {
    ...
    // Load different skins based on settings
    //setStyleByTheme();
...
// Menu leaf node click callback
function clkMenuNodeItem(item) {
    //console.log('Clicked menu item: ' + JSON.stringify(item));
    ...
    // Check if callback event exists
