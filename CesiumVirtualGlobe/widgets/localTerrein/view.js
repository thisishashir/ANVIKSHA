...
function initWidgetView(_thisWidget) {
    ...
    if (thisWidget.config && thisWidget.config.style) { // Adapt to different styles
        $("body").addClass(thisWidget.config.style);
    }

    // Test: called method in [index page corresponding widget.js]
    thisWidget.testFun();
}

// Test
function testIframeFun() {
    // toastr.error('This is a method in the popup');
